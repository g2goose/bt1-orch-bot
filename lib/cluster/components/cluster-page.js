...
function WorkerRow({ worker, roles, onAssignRole, onRename, onUpdateTriggers, onRemove }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "rounded-lg border bg-card p-4", children: [
    ...
    (hasCron || hasFileWatch || hasWebhook) && /* @__PURE__ */ jsxs("div", { className: "mt-3 flex flex-col gap-2", children: [
      ...
      hasWebhook && /* @__PURE__ */ jsxs("div", { className: "rounded-md border border-input p-2.5", children: [
        /* @__PURE__ */ jsx("label", { className: "text-xs font-medium text-muted-foreground block mb-1", children: "Webhook" }),
        /* @__PURE__ */ jsxs("span", { className: "text-xs text-muted-foreground", children: [
          "Endpoint: ",
          /* @__PURE__ */ jsxs("code", { className: "bg-muted px-1 py-0.5 rounded text-foreground", children: [
            "/worker/",
            worker.id,
            "/webhook"
          ] })
